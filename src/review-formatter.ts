...
🐦 **[Share on Twitter](https://twitter.com/intent/tweet?text=${encodeURIComponent(`Karen just roasted my project and gave it a ${review.score.total}/100 ${emoji}\n\n"${review.score.grade}"\n\n${review.bottomLine}\n\nhttps://github.com/khaliqgant/karen-action\n\n#KarenScore #PRPM`)})**
